...
#!/bin/bash
# author：qibotian
# website：https://github.com/qibotian
...
EOF
  ...
  # Gitee Pages
  # git push --force --quiet "https://qibotian:${GITEE_TOKEN}@${GITEE_REF}" master:master
  ...
  # Gitee Pages
  # git push --quiet "https://qibotian:${GITEE_TOKEN}@${GITEE_REF}" master:master --tags
}
